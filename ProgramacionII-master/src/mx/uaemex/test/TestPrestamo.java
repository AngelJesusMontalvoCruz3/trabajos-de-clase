...
public class TestPrestamo {
    ...
    public static void main(String[] args) {
        ...
        alumno1.setId(1);
        alumno1.setNombre("Jose Manuel");
        alumno1.setNumerodeCuenta(20227102);
        alumno1.setApellidoPaterno("Martinez");
        alumno1.setApellidoMaterno("peralta");
        ...
        alumno2.setApellidoPaterno("Montalvo");
        alumno2.setApellidoMaterno("Cruz");

        Alumno alumno3 = new Alumno();
        alumno3.setId(3);
        alumno3.setNombre("Donaji");
        alumno3.setNumerodeCuenta(2273927);
        alumno3.setApellidoPaterno("Ortiz");
        alumno3.setApellidoMaterno("Villa");
        
        Alumno alumno4 = new Alumno();
        alumno4.setId(4);
        alumno4.setNombre("Denis");
        alumno4.setNumerodeCuenta(1916973);
        alumno4.setApellidoPaterno("Castillo");
        alumno4.setApellidoMaterno("Gonzalez");
